...
#' \code{\link{summary}} is perfectly suited for an overview of the estimated parameters, 
#' and \code{\link{plot}} provides visualization of the principal stratification and the outcome distribution.
#' 
